             ...
             <li class="nav-item dropdown pe-3">
                 ...
                 <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                     ...
                     <li>
                         ...
                         <li>
                             <a class="dropdown-item d-flex align-items-center" href="{{ url('admin/my/profile') }}">
                         ...
                         <li>
                             <a class="dropdown-item d-flex align-items-center" href="{{ url('admin/account/settings') }}">
